...
Evidence-backed reviews of usefulness, clarity, quality, and
presentation. CraftAssay writes findings and scores that can be
compared across revisions. Written **CraftAssay**.
npm **`craftassay`**.
